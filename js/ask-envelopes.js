...
export function normalizeAskEntry(value) {
  ...
  unexpected(payload, new Set(['key', 'slice', 'x', 'y', 'question', 'answer', 'crop', 'region', 'contextFingerprint', 'steps']), envelope);
...
export function normalizeAskResult(value) {
  ...
  const payload = objectValue(value, envelope);
  unexpected(payload, new Set(['cached', 'key', 'slice', 'x', 'y', 'question', 'answer', 'crop', 'region', 'contextFingerprint', 'steps']), envelope);
