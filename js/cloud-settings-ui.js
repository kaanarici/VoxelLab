...
function applySettingsToForm(settings) {
  ...
  if (settings.cloudProcessing === false) setStatus('Cloud GPU processing is disabled.', 'warning');
  else if (settings.configured) setStatus('Cloud GPU processing is configured.', 'ready');
