...
//
// Retention is bounded by entry count in addition to browser quota. URLs are
...
export const MAX_VOLUME_CACHE_ENTRIES = 3;
...
export async function trimCacheEntries(cache, maxEntries, protectedKey = '') {
  ...
  for (const key of keys) {
    ...
    try {
      ...
      // Best-effort retention. Browser quota remains the final backstop.
    }
  }
  return removed;
}
