...
import { dot3, geometryFromSeries, isOrthonormalImagePlane, numberList, orientationFromIOP } from '../core/geometry.js';
import {
...
function sameOrientation(frameIop, sourceIop) {
...
function sourceGridSpacing(series) {
...
function sourceContourGridReady(series) {
  const first = numberList(series?.firstIPP, 3);
  const last = numberList(series?.lastIPP, 3);
