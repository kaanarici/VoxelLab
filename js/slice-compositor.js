...
const LUT_UNSET = Symbol('lut-unset');
const _texState = {
  base: {},
  seg: {},
  sym: {},
...
let _grayLutKey = LUT_UNSET;
let _grayLutR = null;
let _grayLutG = null;
let _grayLutB = null;
let _regionLutRef = LUT_UNSET;
let _hotLutRef = LUT_UNSET;
...
function resetUploadGuards() {
  ...
  _grayLutG = null;
  _grayLutB = null;
  _regionLutRef = LUT_UNSET;
  _hotLutRef = LUT_UNSET;
}
...
function fillRegionLut(regionColors) {
  for (let i = 0, p = 0; i < 256; i += 1, p += 4) {
...
function uploadLutsIfChanged(gl, { wlLut, regionColors }) {
  if (_grayLutKey !== wlLut.key || _grayLutR !== wlLut.r || _grayLutG !== wlLut.g || _grayLutB !== wlLut.b) {
    fillGrayLut(wlLut);
    _grayLutKey = wlLut.key;
    _grayLutR = wlLut.r;
    _grayLutG = wlLut.g;
    _grayLutB = wlLut.b;
    uploadLutTexture(gl, _textures.grayLut, _wlLut);
  }
  if (_regionLutRef !== regionColors) {
    fillRegionLut(regionColors);
    _regionLutRef = regionColors;
    uploadLutTexture(gl, _textures.regionLut, _regionLut);
  }
  if (_hotLutRef !== _hotLut) {
    _hotLutRef = _hotLut;
