...
import { initRoiResultsPanel, renderRoiResults } from './js/roi-results.js';
import { initMicroscopyHyperstackControls, renderMicroscopyHyperstackControls } from './js/microscopy-hyperstack-controls.js';
...
import { openShortcutsModal } from './js/shortcuts-modal.js';
...
async function init() {
  ...
  initMicroscopyHyperstackControls({
    onStackChange: () => {
      drawMeasurements();
      renderRoiResults();
    },
...
async function toggleHelp() {
  ...
  $('help-shortcuts-open')?.addEventListener('click', () => {
