...
assert.equal(packageJson.scripts?.['desktop:smoke'], 'npm run desktop:ensure-electron && node --test tests/electron-runtime-smoke.mjs tests/electron-nifti-smoke.mjs tests/electron-tiff-sequence-smoke.mjs tests/electron-microscopy-workflow-smoke.mjs');
