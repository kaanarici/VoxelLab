...
export const PUBLIC_MICROSCOPY_FIXTURE_EVIDENCE = Object.freeze([
  ...
  Object.freeze({
    ...
    coverage: 'public OME-NGFF 0.4 metadata proves axes, pixel type, multiscale level paths, per-level shapes/chunks/compression, channel colors/LUTs/display ranges, per-axis physical units, and coarsest-level local provenance',
    boundary: 'bounded coarsest-level local proof only; the fixture omits chunk payloads, relies on declared zero fill_value, and still keeps full-resolution level-0 eager import over budget',
  }),
]);
