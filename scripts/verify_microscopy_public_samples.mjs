...
export const PUBLIC_MICROSCOPY_FIXTURE_EVIDENCE = Object.freeze([
  ...
  Object.freeze({
    ...
    format: 'ImageJ TIFF',
    coverage: 'public ImageJ Confocal Series sample proves X/Y/Z micrometer calibration, calibrated ROI-results CSV area columns, uint8 pixel type, two channels, Z stacks, and channel-local stack keys',
