...
test('desktopConversionDialogText explains a stale configured converter path', () => {
  assert.equal(
    desktopConversionDialogText([], [{
      name: 'cells.czi',
      conversionReason: 'converter_path_missing',
      converterEnv: 'VOXELLAB_BFCONVERT',
    }]),
    'VOXELLAB_BFCONVERT points to a missing executable. Cannot open 1 converter-backed file: cells.czi until it is configured.',
  );
});
