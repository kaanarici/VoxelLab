...
def test_public_export_sanitizes_provider_config_and_sync_scripts(tmp_path):
        ...
        json.dumps(
            {
                "scripts": {
                    ...
                    "desktop:smoke": "npm run desktop:ensure-electron && node --test tests/electron-runtime-smoke.mjs tests/electron-nifti-smoke.mjs tests/electron-tiff-sequence-smoke.mjs tests/electron-microscopy-workflow-smoke.mjs",
    ...
    assert package["scripts"]["check:lab"] == "node scripts/check_lab_readiness.mjs --skip-validation-matrix --skip-public-export --skip-demo-pack --skip-converters"
    ...
    assert package["scripts"]["desktop:smoke"] == "npm run desktop:ensure-electron && node --test tests/electron-runtime-smoke.mjs tests/electron-nifti-smoke.mjs tests/electron-tiff-sequence-smoke.mjs tests/electron-microscopy-workflow-smoke.mjs"
