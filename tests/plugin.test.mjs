...
test('drawing without plugin overlays avoids snapshot work', () => {
...
test('plugin context menu conditions share one state snapshot per event', () => {
  const snapshots = [];
  let prevented = false;
