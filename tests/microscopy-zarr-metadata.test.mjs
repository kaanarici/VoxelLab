...
const {
  normalizeOmeZarrMetadata,
  omeZarrMetadataIssueLabels,
} = await import('../js/microscopy/microscopy-zarr-metadata.js');
...
test('omeZarrMetadataIssueLabels keeps common metadata failures readable', () => {
  assert.deepEqual(omeZarrMetadataIssueLabels([
    'axes_channel_or_custom_order_invalid',
    'dataset_0_translation_before_scale',
  ]), [
    'Channel/custom axes must appear before spatial axes',
    'Dataset 0 translation before scale',
  ]);
});
