...
fzstd, so a client streaming from R2 gets exactly the same 16-bit
precision volume it uses locally — without shipping hundreds of
megabytes of raw data with the app.
