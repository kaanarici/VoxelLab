...
def main() -> bool:
    ...
    updates = {slug: {"hasRegions": True, "anatomySource": "totalseg"} for slug in ct_success}
    if mr_result[0] and mr_ref:
        updates[mr_ref] = {"hasRegions": True, "anatomySource": "totalseg"}
