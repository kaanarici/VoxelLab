...
def normalize_ask_entry(value: Any) -> dict[str, Any]:
    ...
    _unexpected(payload, {"key", "slice", "x", "y", "question", "answer", "crop", "region", "contextFingerprint"}, envelope)
...
def normalize_ask_result(value: Any) -> dict[str, Any]:
    ...
    _unexpected(
        payload,
        {"cached", "key", "slice", "x", "y", "question", "answer", "crop", "region", "contextFingerprint"},
        envelope,
    )
