...
const CORE_ASSETS = [
  ...
  './js/desktop-window-chrome.js',
  './js/dicom-codecs.js',
  './js/dicom-derived-import.js',
  './js/dicom-frame-meta.js',
  './js/dicom-import-classify.js',
  './js/dicom-import-geometry.js',
  './js/dicom-import-parse.js',
  './js/dicom-import-routing.js',
  './js/dicom-import.js',
  './js/dicom-meta.js',
  './js/dicom-pixel-data.js',
  ...
  './js/measure.js',
  './js/metadata.js',
  './js/microscopy-dataset-model.js',
  './js/microscopy-channel-composite.js',
  './js/microscopy-display-range.js',
  './js/microscopy-hyperstack-controls.js',
  './js/microscopy-import.js',
  './js/microscopy-ome-channel-metadata.js',
  './js/microscopy-sequence-import.js',
  './js/microscopy-workflow-recipe.js',
  './js/microscopy-zarr-import.js',
  './js/microscopy-zarr-metadata.js',
  './js/mode-flags.js',
  './js/mpr-geometry.js',
  './js/mpr-gpu.js',
  ...
  './js/series-view-activation.js',
  './js/series-capabilities.js',
  './js/series-contract.js',
  './js/series-identity.js',
  ...
  './js/state/series-view-memory.js',
  ...
  './js/volume-raycast-steps.js',
  './js/volume-raw-normalize.js',
